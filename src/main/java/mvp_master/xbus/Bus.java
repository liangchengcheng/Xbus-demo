...
import mvp_master.xbus.method.AnnotationMethodFinder;
import mvp_master.xbus.method.MethodFinder;
import mvp_master.xbus.method.NamedMethodFinder;
import mvp_master.xbus.scheduler.Scheduler;
import mvp_master.xbus.scheduler.Schedulers;
...
public class Bus {
    ...
    static class Cache{
        //key=注册类的完整的类名，target.getClass().getName();
        //value=注册类包含的合法的@BusReceiver方法对象集合
        //targetTypeName -> method set
        final static Map<String,Set<MethodInfo>> sMethodCache=new ConcurrentHashMap<>();
